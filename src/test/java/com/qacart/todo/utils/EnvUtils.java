...
public class EnvUtils {
    ...
    private EnvUtils() throws IOException {
        ...
        switch (env){
            case "PRODUCTION" -> {
                prop = ConfigUtil.readConflig("src/test/resources/properties/production.properties");
            }
            case "STAGING" -> {
                prop = ConfigUtil.readConflig("src/test/resources/properties/staging.properties");
            }
            case "LOCAL" -> {
                prop = ConfigUtil.readConflig("src/test/resources/properties/local.properties");
            }
            default -> {
